          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(attr, index) in spuSaleAttrList" :key="attr.id">
                ...
                >
                  <!-- value是冰月白 雾霾蓝所在的对象，这里面有ischecked属性，通过这个属性来排他。attr.spuSaleAttrValueList就是所有包含ischecked组成的数组 -->
                  <!-- 我们就是要用排他思想遍历这个数组，把点击的ischecked变成1 其他的变成0 -->
...
export default {
  ...
  methods: {
    changeActive(attrvalue, attrvalueArr) {
      // 遍历全部属性值的ischecked
      attrvalueArr.forEach((item) => {
        item.isChecked = 0
      })
    ...
    async AddCar() {
      ...
      try {
        ...
        //跳转到路由组件  先把商品信息存储到sessionstorage
